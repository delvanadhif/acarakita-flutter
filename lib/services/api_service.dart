...
class ApiService {
  ...
  // dapetin token di SharedPreferences
  ...
  // mendapatin daftar event sama filter opsional
      ...
      if (response.statusCode == 200) {
        ...
        if (responseBody['success'] == true) {
          if (responseBody['data'] != null &&
            ...
            return eventData.map((json) => Event.fromJson({
              'id': json['id'],
              'title': json['title'],
              ...
              'registrations_count': json['registrations_count'],
              'category': json['category'],
              'created_at': json['created_at'],
              'image_url': json['image_url'] ?? '',
            })).toList();
          } else {
            return []; // return empty list kalo gk ada event
          }
        } else {
